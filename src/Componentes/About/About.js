      ...
      <div className='text_container' data-aos="fade-up" data-aos-duration="2000">
        {
          language === 'EN' ?
            <>
              <h1>About</h1>
              <p>
                Hi, I'm Rodrigo, Full Stack Developer and I work as a FrontEnd developer at <a className='link'  rel="noreferrer" href='https://www.stamm.bio/' target='_blank'>Stämm Biotech</a>.
            ...
            <>
              <h1>Sobre mí</h1>
              <p>
                Hola, soy Rodrigo, Desarrollador Full Stack y trabajo como desarrollador FrontEnd para <a className='link'  rel="noreferrer" href='https://www.stamm.bio/' target='_blank'>Stämm Biotech</a>. 
