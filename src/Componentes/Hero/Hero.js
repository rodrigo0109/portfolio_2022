...
import Resume from '../../file/Rodrigo_Perez_Fullstack_Developer_2024.pdf'
    ...
    <div ref={heroRef} className='hero' id='/' >
      ...
      <div className='hero_intro_container' data-aos="fade-up" data-aos-duration="2000">
        ...
        <div className='subtitle-action_container'>
          ...
          <a href={language === 'EN' ? Resume : Resume} download={language === 'EN' ? "Rodrigo_Perez_Fullstack_Developer_2024.pdf" : 'Rodrigo_Perez_Fullstack_Developer_2024.pdf.pdf'} target="_blank" rel="noopener noreferrer">{ language === 'EN' ? 'Resume' : 'CV' }</a>
        </div>
      </div>
